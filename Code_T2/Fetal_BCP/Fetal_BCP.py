...
def mix_loss(output, img_l, patch_l, mask, l_weight=1.0, u_weight=0.5, unlab=False):
    ...
    if img_l.ndim == 3:  
        img_l = F.one_hot(img_l.long(), num_classes=3).permute(0, 3, 1, 2).float()  
    if patch_l.ndim == 3:
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(description='Train with Fetal_BCP')
    parser.add_argument('--exp', type=str, default='tmp')
    parser.add_argument('--config_yml', type=str, default='Configs/multi_train_local.yml')
    parser.add_argument('--adapt_method', type=str, default=False)
    parser.add_argument('--num_domains', type=str, default=False)
    parser.add_argument('--dataset', type=str, nargs='+', default='fugc')
    ...
    for fold in [1, 2, 3, 4, 5]:
        ...
        pre_snapshot_path = exp_dir  
        snapshot_path = exp_dir      
